...
person.prototype.isHeigth = () => {
    return this.heigth > 1.8 // Undifined, because this is not this from the object is from window, the global object. The correct way is using function
}
